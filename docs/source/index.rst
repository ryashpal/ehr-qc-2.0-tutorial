...
Together, these updates enable fully automated workflows, robust interoperability, and improved accessibility making the latest EHR-QC a more powerful and user-friendly tool for healthcare data analytics.
...
.. note::
   ...
   In this documentation, we provide detailed usage information about the enhancements that are part of new EHR-QC version. The usage instructions for the original version of EHR-QC can be found here `https://ehr-qc-tutorials.readthedocs.io/ <https://ehr-qc-tutorials.readthedocs.io/>`_
